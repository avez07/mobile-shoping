        ...
        <div class="container-fluid d-flex">
            ...
            <div class="address-info">
                <div class="tabular-add">
                    <form action="partial/deals-add.php" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-6 py-4 text-capitalize fw-semibold brown">
                                <label for="oldpassword">footwear name</label>
                                <input type="text" class="form-control" id="add-form" name="foot_name">
                            </div>
                            ...
                            <div class="col-md-6 py-4 text-capitalize fw-semibold brown">
                                <label for="foot-type">footwear type</label><br>
                            ...
                            <div class="col-md-6 py-4 text-capitalize fw-semibold brown">
                                <label for="foot-categories">categories</label><br>
