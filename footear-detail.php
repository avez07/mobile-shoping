      ...
      <div class="mx-4" style="width: 25%;">
          <div class="profile-mage">
            ...
            <div class="tabular d-flex justify-content-center align-items-center">
                <ul class="add-links">
                    ...
                    <li class="active"><span><a href="adreress.html" class="text-dark" style="text-decoration: none;"><i class="fa-solid fa-location-dot pe-2 active-2"></i></span>todays deals</a></li>
                    <li><span><i class="fa-solid fa-briefcase pe-2"></i></span>orders</li>
                    <li><span><a href="change-password.html" class="text-dark" style="text-decoration: none;"><i class="fa-solid fa-key pe-2"></i></span>shoes data</a></li>
        ...
        <div class="address-info">
            <div class="tabular-add">
               <form action="partial/footwear-detail-add.php" method="post" >
                <div class="row">
                    ...
                    <div class="col-md-6 py-4 text-capitalize fw-semibold brown" >
                        <label for="foot-img">footwear image</label>
                        <input type="text" class="form-control" id="add-form" name="foot-img">
                    </div>
                    ...
                    <div class="col-md-6 py-4 text-capitalize fw-semibold brown" >
                        ...
                        <select class="form-select" id="select" aria-label="Default select example" name="categories">
